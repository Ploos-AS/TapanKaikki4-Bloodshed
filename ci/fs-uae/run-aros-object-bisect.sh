...
probes=(
  ...
  "types-enemy-a:tk4-types-enemy-a-probe:m3-types-enemy-a-main.txt"
  "types-enemy-b:tk4-types-enemy-b-probe:m3-types-enemy-b-main.txt"
  "types-enemy-c:tk4-types-enemy-c-probe:m3-types-enemy-c-main.txt"
